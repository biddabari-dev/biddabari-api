...
class PracticeExamResult extends Model
{
    ...
    protected $table = 'practice_exam_results';

    protected static $xmResult;

    public static function storeExamResult($arrayData, $examResultId = null)
    {
        return PracticeExamResult::updateOrCreate(['id' => $examResultId], $arrayData);
    }

    public static function updateXmResult($request, $examOf)
    {
        self::$xmResult = PracticeExamResult::find($request->xm_result_id);
